<div class="row content">
	<div class="row-fixed">
		...
		<form action="<?= SITE_URL ?>home/bulk_pass" method="post">
		<div class="row helper-menu">
			<ul>
				<li><button type="submit" name="submit" class="__btn __btn-link-small __btn-grey __btn-round">Issue Passes</button></li>
			</ul>
		</div>
		<div class="row">
			<table class="layout">
